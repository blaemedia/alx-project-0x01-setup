// UserModal.tsx
import { User } from "@/interfaces"; // import the User interface you created
    ...
    <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
      <div className="bg-white rounded-lg p-8 shadow-lg w-full max-w-lg overflow-y-auto max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Address */}
          <h3 className="text-lg font-semibold mt-6 mb-2 text-gray-800">Address</h3>
          <div className="mb-4">
            <input
              type="text"
              name="address.street"
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-gray-800">Geo</h3>
          ...
          {/* Company */}
          <h3 className="text-lg font-semibold mt-6 mb-2 text-gray-800">Company</h3>
          <div className="mb-4">
            <input
              type="text"
              name="company.name"
